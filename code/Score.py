...
from code.Const import SCORE_POS, gerar_cor_rainbow, MENU_OPTION, C_WHITE, C_BLACK
...
class Score:
    ...
    def score_text(self, text_size: int, text: str, text_color: tuple, text_center_pos: tuple):
        ...
        # Criar a fonte para o texto

        text_font: Font = pygame.font.SysFont(name="Open Sans", size=text_size)

        # Renderizar a superfície do texto com as propriedades especificadas

        text_surf: Surface = text_font.render(text, True, text_color).convert_alpha()

        # Obter o retângulo do texto centralizado na posição especificada
